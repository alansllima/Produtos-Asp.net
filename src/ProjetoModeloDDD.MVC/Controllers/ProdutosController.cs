...
namespace ProjetoModeloDDD.MVC.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        //{
        //    var ProdutoViewModel = Mapper.Map<IEnumerable<Produto>, IEnumerable<ProdutoViewModel>>(_produtoApp.ObterProdutosEspeciais());
        //    return View(ProdutoViewModel);
        //}
        ...
        public ActionResult Edit(ProdutoViewModel produto)
        {
            ...
            return View(produto); // retornar para a mesma view os dados preenchidos
        }
